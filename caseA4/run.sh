#
mpirun -np 2 -genv I_MPI_FABRICS shm:ofa -machinefile ../machinefile ./../wtdbg2 -x rs -g144m -t32 -i /nfs_public/wtdbg/data/melanogaster_A4_subreads.fastq.gz -fo a4 2>&1 | tee log.txt
# > log.txt 2>&1
