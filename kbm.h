...
static inline void map_kbm_timer(KBMAux *aux,int tid){
	KBM *kbm;
	kbm_ref_t *ref;
	kbm_baux_t *saux;
	u4v *heap;
...
#endif
#ifdef LT_TIMER
			lt_timer_stop(16, tid);
#endif
#ifdef LT_TIMER
			lt_timer_stop(15, tid);
#endif
